    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="维修状态" prop="status">
          <el-select v-model="form.status" placeholder="请选择是否派修">
        ...
        <el-form-item label="维修描述" prop="repairDescription">
          <el-input v-model="form.repairDescription" placeholder="请输入维修描述" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除request编号为"' + ids + '"的数据项？').then(function() {
